...
export const breathingProtocols: Record<TechniqueId, BreathingProtocol> = {
  ...
  [TECHNIQUE_IDS.CO2_TOLERANCE]: {
    ...
    shortName: 'CO2 Table',
    description: 'Breath holds that increase by 5 seconds each round. Adapted from freediving CO2 tables.',
    science: 'Holding your breath raises blood CO2, which normally triggers the urge to breathe. Progressive tables rehearse staying composed as that signal rises. Breath-hold physiology is well described, and a small conference study of nasal/apnea training in cyclists reported improved CO2 tolerance and threshold-power measures after 6 weeks. Performance evidence is limited. This is composure practice during air hunger, not an endurance program.',
    evidence: 'Freediving tables',
    evidenceLevel: 'promising',
    citations: [protocolCitations.parkes2006, protocolCitations.murphey2020],
    purpose: 'Train composure as CO2 rises',
    category: 'performance',
    intensity: 'advanced',
    bestFor: ['Breath-hold training', 'Composure', 'Air hunger'],
    breathsPerMinute: 1.2,
    caution: 'Practice seated or lying down. Stop immediately if dizzy, tingling, or panicked.',
    safetyNotice: 'This protocol uses progressive breath holds. Sit or lie down before you start.',
    contraindications: [
  ...
  [TECHNIQUE_IDS.CYCLIC_SIGHING]: {
    ...
    citations: [protocolCitations.balban2023, protocolCitations.zaccaro2018],
    purpose: 'Lower anxiety in five minutes',
    category: 'calm',
    intensity: 'gentle',
    bestFor: ['Anxiety', 'After stress', 'Midday'],
    breathsPerMinute: 6,
  ...
  [TECHNIQUE_IDS.RESONANCE_BREATHING]: {
    ...
    shortName: 'Resonance',
    description: '5-second inhale, 5-second exhale, 6 breaths/min. The cadence used in HRV biofeedback.',
    ...
    purpose: 'Train HRV at 6 breaths per minute',
    category: 'calm',
    intensity: 'gentle',
    bestFor: ['Daily practice', 'HRV training', 'Steady calm'],
    breathsPerMinute: 6,
  ...
  [TECHNIQUE_IDS.DIAPHRAGMATIC_BREATHING]: {
    ...
    shortName: 'Belly',
    description: '4-second inhale, 4-second exhale, no holds. Belly-led breathing.',
    science: 'Diaphragmatic breathing trains the diaphragm to lead the breath instead of the upper chest. Randomized research in healthy adults found improved sustained attention, lower negative affect, and reduced cortisol after structured practice. A recent systematic review found promising benefits for anxiety and several clinical conditions, while noting that protocols and study quality remain mixed. This is a breathing drill, not a medical treatment.',
    ...
    purpose: 'Quiet belly breathing, no holds',
    category: 'calm',
    intensity: 'gentle',
    bestFor: ['Beginners', 'Body awareness', 'Easy start'],
  ...
  [TECHNIQUE_IDS.EXTENDED_EXHALE]: {
    ...
    shortName: 'Exhale',
    description: '4-second inhale, 6-second exhale, 6 breaths/min. No holds.',
    science: 'Slow breathing below 10 breaths/min is associated with increased HRV and respiratory sinus arrhythmia. Research on exhale-heavy ratios is mixed, but multiple studies report stronger cardiac vagal activity when exhalation is longer than inhalation. This protocol keeps the cadence easy and makes the exhale longer than the inhale.',
    evidence: 'Slow-breathing research',
    evidenceLevel: 'strong',
    citations: [protocolCitations.zaccaro2018],
    purpose: 'Longer exhale, no holds',
    category: 'calm',
    intensity: 'gentle',
    bestFor: ['Anxiety spikes', 'No holds', 'Before sleep'],
    breathsPerMinute: 6,
  ...
  [TECHNIQUE_IDS.FOUR_SEVEN_EIGHT]: {
    ...
    category: 'sleep',
    intensity: 'moderate',
    bestFor: ['Before bed', 'Racing thoughts', 'After anger'],
  ...
  [TECHNIQUE_IDS.PURSED_LIP_RECOVERY]: {
    ...
    purpose: 'Slow the breath after exertion',
    category: 'recovery',
    intensity: 'gentle',
    bestFor: ['After exercise', 'Shallow breathing', 'Easy recovery'],
    breathsPerMinute: 10,
