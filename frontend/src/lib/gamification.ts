...
const LEVEL_TITLES: [number, string][] = [
  ...
  [25, 'Flow State'],
  [30, 'Resonance Guide'],
  [35, 'Regulation Steward'],
  [40, 'Protocol Scholar'],
  [45, 'Breathwork Mentor'],
  [50, 'Breathwork Steward'],
]
...
export const BADGES: Badge[] = [
  ...
  {
    id: 'sessions_100',
    name: 'Century Practice',
    description: 'Complete 100 guided sessions',
    icon: 'Award',
  },
  {
    id: 'hour_total',
    name: 'One-Hour Baseline',
    description: 'Accumulate 1 hour of guided breathing time',
    icon: 'Clock',
  },
  {
    id: 'ten_hours',
    name: 'Ten-Hour Reserve',
    description: 'Accumulate 10 hours of guided breathing time',
    icon: 'Timer',
  },
  {
    id: 'box_master',
