      ...
      <div className="space-y-8 sm:space-y-10">
        ...
        <motion.div variants={fadeUp} className="border-t border-bw-border pt-5">
          ...
          <div>
            {/* Filter Buttons */}
            <div
              className="flex max-w-full min-w-0 gap-4 mb-5 sm:mb-6 border-b border-bw-border pb-3 overflow-x-auto overflow-y-hidden overscroll-x-contain touch-pan-x no-scrollbar"
              role="group"
