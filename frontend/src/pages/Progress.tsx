      ...
      <div className="space-y-8 sm:space-y-10">
            ...
            {showClearConfirm ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl text-xs font-semibold surface-well text-zinc-500 hover:text-zinc-700 transition-colors duration-300"
                >
                  No
                </button>
              </div>
              ...
              <button
                ...
                className="px-3 py-2 rounded-xl text-sm text-zinc-300 hover:text-red-400 hover:bg-red-500/10 transition-colors duration-300"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1 min-w-0 space-y-3">
                <div>
                  ...
                  <div className="font-display text-xl font-bold text-zinc-900">{levelTitle}</div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="text-[11px] text-zinc-400 font-medium tabular-nums">
          ...
          <motion.div variants={fadeUp}>
            <h2 className="font-display text-lg font-bold text-zinc-900 mb-4">
              Activity
            </h2>
